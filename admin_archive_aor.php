    ...
    <div class="card flex-fill">
      <div class="card-header">
        ...
        <ul class="nav nav-tabs">
          <li class="nav-item">
            <a class="nav-link active" href="#announcement-contents" id="announcement-tab" data-bs-toggle="tab">Area of Responsibility</a>
          </li>
          <!-- <li class="nav-item">
        ...
        <div class="tab-content">
          <div id="announcement-contents" class="tab-pane active">
