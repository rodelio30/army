...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <table id="archive_seminars" class="table table-striped" style="width:100%">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Date Modified</th>
                        ...
                        if ($archive_seminars_counter > 0) {
                            ...
                            $time_formatted   = date("g:i A ", strtotime($time_modified));
                                ...
                                <tr>	
                                    ...
                                    <a href=\"archive/seminars/seminars_active.php?ID=$seminar_id\" onClick=\"return confirm('Are you sure you want this seminar return to active?')\" class='btn btn-outline-primary btn-md float-end'><span data-feather='file-plus'></span>&nbsp Active?</a>
                                    </td>
                                </tr>
                            ";
                            }
                        } else {
                            echo " <tr>	<td></td> <td></td> <td class='text-center'>No Active seminar</td> <td></td> </tr>";
                        }
                        ?>
                    </tbody>
                </table>
