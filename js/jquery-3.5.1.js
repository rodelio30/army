...
$(document).ready(function () {
  $("#archive_announcements").DataTable({
    order: [[0, "asc"]],
    pagingType: "full_numbers",
    lengthMenu: [
      [10, 25, 50, -1],
