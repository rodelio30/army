...
if (isset($_POST['update'])) {
  ...
  mysqli_query($conn, "update schools set school_name = '$school_name', acronym = '$acronym', description = '$description', status = '$status', date_modified = '$date_modified', time_modified = '$time_modified' where school_id = '$schools_id'") or die("Query 4 is incorrect....");
        ...
        <div class="main">
            ...
            <main class="content">
              <div class="container-fluid p-0">
                <h1 class="h3 mb-3"><a href="admin_schools.php" class="linked-navigation">School List</a> / <?php echo $acronym?></h1>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <form method="post" autocomplete="off">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-sm-10 text-secondary">
                                      <select class="form-control" id="status" value="<?php echo $status ?>" name="status">
                                        ...
                                        <option value="inactive" <?php echo $sel_inactive ?>>Inactive</option>
                                      </select>
                                    </div>
                                  </div>
                                  <hr>
                                  <div class="row">
                                    <div class="col-sm-2">
                                      <h6 class="mb-0 flatpickr-weekwrapper"><strong>Date Created</strong></h6>
                                    </div>
                                    <div class="col-sm-10 text-secondary">
                                 ...
                                 <br> 
                                  <div class="row">
                                    <div class="col-sm-2">
                                      <h6 class="mb-0 flatpickr-weekwrapper"><strong>Date Modified</strong></h6>
                                    </div>
                                    <div class="col-sm-10 text-secondary">
                                      <div class="flatpickr-weekwrapper">
