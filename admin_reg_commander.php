        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3 header-dash">Commander List
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    //   echo "<script>console.log('" . $reservist_counter . "');</script>";
                                            ...
                                            $result = mysqli_query($conn, "select reg_id, username, user_type, rank_id, company_id, school_id, status, date, time from registration_user WHERE status = 'pending' && user_type='commander' ORDER BY date") or die("Query for latest commander....");
