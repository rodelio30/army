     ...
     if (mysqli_query($conn, $query_army_user)) {
        if($user_type == 'reservist'){
          ...
          // Inserting other info for reservist in reservist table 
            mysqli_query($conn, "INSERT INTO reservists VALUES('','$reserve_id','$firstname','','$lastname','','$afpsn','$rank','','','','','','','$school_graduated','Pending','$up_user_status','$date_modified','$time_modified','$date_modified','$time_modified')")  or die("Query Reservist Table is incorrect.....");
