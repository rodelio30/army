...
if (isset($_POST['submit'])) {
  ...
  if(mysqli_num_rows($duplicate) > 0){
    ...
    "<script> alert('Acronym or School name Has Already Taken'); </script>";
      ...
      $query = "INSERT INTO schools VALUES('','$school_name','$acronym','$description','$status','$date','$time','$date','$time','$un_public')";
                                  ...
                                  <form method="post">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="acronym" name="acronym"
                                        placeholder="Enter School Acronym" required autofocus>
                                    </div>
                                    <br>
                                    <div class="form-group">
