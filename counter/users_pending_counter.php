...
$sql_reservist = "SELECT reg_id FROM registration_user WHERE user_type='reservist' && user_status = 'inactive' ";
...
$sql_admin = "SELECT reg_id FROM registration_user WHERE user_type='admin' && user_status = 'inactive' ";
...
$sql_staff = "SELECT reg_id FROM registration_user WHERE user_type='staff' && user_status = 'inactive' ";
...
$sql_commander = "SELECT reg_id FROM registration_user WHERE user_type='commander' && user_status = 'inactive' ";
...
$sql_school = "SELECT sc_id FROM registration_sc WHERE user_type='school_coordinator' && user_status = 'inactive' ";
