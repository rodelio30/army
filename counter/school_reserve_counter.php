...
if ($result_rg->num_rows > 0) {
  ...
  $sql_ws = "SELECT rg_id FROM rotc_graduates WHERE status != 'archive' && school_graduated = '$school_name_public'";
  ...
  $sql_male = "SELECT rg_id FROM rotc_graduates WHERE sex = 'male' && status != 'archive' && school_graduated = '$school_name_public'";
  ...
  $sql_fm = "SELECT rg_id FROM rotc_graduates WHERE sex = 'female' && status != 'archive' && school_graduated = '$school_name_public'";
