        ...
        <div class="main">
            ...
            <main class="content">
              <div class="container-fluid p-0">
                <div class="row">
                  <div class="col-md-9">
                    <h1 class="h3 mb-3">School List</h1>
                  </div>
                  <div class="col-md-3">
                  <a <?php echo "href=\"admin_schools_add.php\"" ?> style="float: right" id="action-print" class="btn btn-outline-success"><span
                      data-feather="user-plus"></span>&nbsp Add School</a>
                  </div>
                </div>
                                            ...
                                            while (list($school_id, $school_name, $acronym, $status, $date_modified) = mysqli_fetch_array($result)) {
                                                echo "
                                                    <tr>	
                                                        ...
                                                        <td>$date_modified</td>
                                                        <td>$status</td>
                                                        <td id='action-print'><a href=\"archive/schools/schools_archive.php?ID=$school_id\" onClick=\"return confirm('Are you sure you want this school move to archive?')\" class='btn btn-warning btn-md float-end ms-2'><span><img src='img/icons/archive.png' style='width:15px'></span>&nbsp Archive</a></td>
                                                    </tr>
                                                ";
                                            }
                                            }
                                            else {
                                                echo " <tr>	<td colspan='5' class='text-center'>No Active School</td></tr>";
                                            }
                                        ?>
                                                </tbody>
                                            </table>
