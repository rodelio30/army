 <?php 
    ...
    $sql ="SELECT count(*) as total, ranks.acronym FROM reservists INNER JOIN ranks ON reservists.rank_id=ranks.rank_id where reservists.user_status != 'archive' group by ranks.acronym;";
...
<div class="card-body py-3">
    <div class="chart chart-sm" style="height: 70%;">
        <canvas id="chartjs-dashboard-bar"></canvas>
    </div>
    <div class="mt-3" style="height: 150px; overflow-y:auto;">
